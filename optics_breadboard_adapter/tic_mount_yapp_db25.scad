...
cutoutsBase = 
[
    [0, 0, pcbLength, pcbWidth, 0, yappRectangle, maskBars, yappCoordPCB],
];
...
cutoutsFront =  
[
    [0, 0, pcbWidth + paddingRight + paddingLeft-10, 10, 0, yappRectangle, yappCenter, maskBars],
];

cutoutsBack = 
[
    [0, 3, pcbWidth + paddingRight + paddingLeft-10, 10, 0, yappRectangle, yappCenter, maskBars],
];

cutoutsLeft =   
[
    [30, 0, 37.51+2.51*2 + 0.1, 10.67+0.1, 2.51, yappRoundedRect, yappDefault,   0, yappCenter],
    [30-47.04/2, 0, 0, 0, 1.6, yappCircle, yappDefault, 0 , yappCenter],
    [30+47.04/2, 0, 0, 0, 1.6, yappCircle, yappDefault, 0 , yappCenter],
];
...
boxMounts =
[
    [ 13, 0.25*25.4 + 0.2, shellWidth, 7, yappBack],
    [-13, 0.25*25.4 + 0.2, shellWidth, 7, yappFront]
];
...
lightTubes =
[
    [7.4, 9, 2, 2, 1, 0.5, yappCircle, 0.],
    [5.8, 26.7-12.4, 2, 2, 1, 0.5, yappCircle, 0.],
    [9.5, 26.7-9.7, 2, 2, 1, 0.5, yappCircle, 0.],
];
...
module place_tic500(){
  ...
  translate([paddingBack + wallThickness, paddingLeft + wallThickness, standoffHeight + basePlaneThickness])
  import( "../tic-wright-stage-retrofit/ImageToStl.com_tic-t825-usb-multi-interface-stepper-motor-controller.stl");
}
